...
namespace Example
{
    ...
    // ═══════════════════════════════════════════════════════════════
    // دالة مساعدة لإضافة مربع مع Normal
    // ═══════════════════════════════════════════════════════════════
